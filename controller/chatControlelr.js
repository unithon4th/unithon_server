    ...
    static add(userId, chatText) {
        return new Promise((resolve, reject) => {
            chatService_1.default.addChat(userId, chatText).then((data) => {
                let type = '';
                if (data['result']['parameters']['card'])
                    type += data['result']['parameters']['card'];
                else if (data['result']['parameters']['elec'])
                    type += data['result']['parameters']['elec'];
                else if (data['result']['parameters']['gas'])
                    type += data['result']['parameters']['gas'];
                else if (data['result']['parameters']['water'])
                    type += data['result']['parameters']['water'];
